...
from transformers import RobertaTokenizerFast, DataCollatorForLanguageModeling, RobertaForMaskedLM, AutoConfig, \
    TrainingArguments, Trainer, RobertaForCausalLM

MY_MODEL_HF_ID: str = "Brendan/baby-roberta-causal"
...
if __name__ == '__main__':
    ...
    # load the baby lm corpus and train a tokenizer
    ...
    # Note: mlm=False! this is a causal model. Look at forward in RobertaForCausalLM, and one can see when we omit a
    # labels argument, it computes a causal lm loss by taking care of shifting for us
    ...
    wandb.init(entity="kingb12", project="roberta_causal_pretrain_example")
    ...
    model.save_pretrained(os.path.join("outputs/final-checkpoint/roberta-causal"))
