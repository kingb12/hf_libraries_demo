...
from transformers import AutoModelForCausalLM, AutoTokenizer, Trainer, get_cosine_schedule_with_warmup
...
class SimpleTrainer:
    ...
    def __init__(self, model: nn.Module, max_train_steps: int, train_dataloader: DataLoader, eval_dataloader: DataLoader, eval_steps: int,
    ...
    def train(self):
        ...
        wandb.log({
            ...
            "train/achieved_tflops": self.train_flos / self.time_in_train_step
        })
